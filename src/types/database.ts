    ...
    Tables: {
      ...
      job_functions: {
        Row: {
          ...
          contract_type: "pf" | "pj";
          workload_reference: string | null;
          salary_range_min_cents: number | null;
          salary_range_max_cents: number | null;
          required_document_types: string[];
          requires_coordinator: boolean;
          suggested_role_codes: string[];
          status: "ativa" | "inativa";
        ...
        Update: Partial<Database["public"]["Tables"]["job_functions"]["Insert"]>;
        Relationships: [];
      };
      legal_entities: {
        Row: {
          ...
          status: "rascunho" | "ativo" | "suspenso" | "arquivado";
          created_by: string | null;
          updated_by: string | null;
          created_at: string;
          updated_at: string;
