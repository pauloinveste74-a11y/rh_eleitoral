...
| Cabeçalho/rodapé do contrato impresso + variáveis `{{organizacao_*}}` no corpo (docs/CENTRAL_INTELIGENCIA_RH_MATRIZ.md; caderno jurídico em docs/CADERNO_DOCUMENTAL_JURIDICO_CONTRATOS_RH_ELEITORAL.md, não analisado por inteiro ainda) | `/contratos/[id]`, `/master/organizacoes/[id]` | — |
